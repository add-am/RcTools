#' Table Containing Testing Values
#'
#' A table containing a range of values to perform tests on the scoring and grading functions
#'
#' @format ## `tbl5`
#' A dataframe with 14 rows and 10 columns:
#' \describe{
#'   \item{wqo}{A numeric column containing two different water quality objective value options}
#'   \item{sf}{A numeric column containing two different scaling factor options}
...
#'   \item{fish_test}{A numeric column containing a range of possible fish values}
#'   ...
#' }
#' @source NA - this is a completely made up dataset.
"tbl5"