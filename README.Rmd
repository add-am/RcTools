...
![After Report Card Formatting](man/figures/README-after-report-card-formatting.png)

Equally, rainfall data looks like this:

![After Rainfall Formatting](man/figures/README-after-rainfall-formatting.png)

temperature data looks like this:

![After Temperature Formatting](man/figures/README-after-temperature-formatting.png)

summary statistics data looks like this:

![After Summary Statistic Formatting](man/figures/README-after-summary-statistic-formatting.png)

and presence absence data looks like this:

![After Presence Absence Formatting](man/figures/README-after-presence-absence-formatting.png)