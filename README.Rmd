...
Functions under each theme are explained below. Alternatively, individual function documentation can be accessed with the command `?fnc_name`.
...
The `ereefs_reproject` function takes a curvilinear netCDF object and returns a regular grid netCDF object. The curvilinear netCDF object is generally produced by the `ereefs_extract` function.
